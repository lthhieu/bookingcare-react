...
class ModalUserRedux extends Component {
    ...
    async componentDidMount() {
        ...
        // try {
        //     let resGender = await this.handleGetGendersFromServer('gender')
        //     this.setState({
    ...
    // handleGetGendersFromServer = (data) => {
    //     return services.getAllCode(data)
    // }
    ...
    render() {
        let { genders, roles, positions, previewImgURL, isOpen, fNameVi, fNameEn, lNameVi, lNameEn, email, password, addressVi, addressEn, phoneNo, fNameVi_ERR, fNameEn_ERR, lNameVi_ERR, lNameEn_ERR, email_ERR, password_ERR, addressVi_ERR, addressEn_ERR, phoneNo_ERR, gender, roleId, positionId, action } = this.state
                            ...
                            <div className='col-12'>
                                <div className='card'>
                                    <div className="card-header">
                                        <h3 className='card-title'><FormattedMessage id="users.user-redux.title.title1" /></h3>
                                        <div className="card-tools">
                                            <button onClick={() => this.handleResetError()} type="button" className="btn btn-tool" data-card-widget="collapse">
                                        ...
                                        <div className="form-row">
                                            ...
                                            <div className="form-group col-md-4">
                                                ...
                                                <div className='upload-avatar'>
                                                    ...
                                                    <label className='btn btn-warning' htmlFor='input-file'><FormattedMessage id="users.user-redux.body.text14" /> <i className="fa-solid fa-upload"></i></label>
                                    ...
                                    <div className='card-footer my-1'>
                                        <button onClick={() => this.handleSaveOrUpdateUser()} type="button" className={action === utils.CRUD.UPDATE ? "btn btn-success" : "btn btn-primary"}>{action === utils.CRUD.UPDATE ? <FormattedMessage id="users.user-redux.footer.button2" /> : <FormattedMessage id="users.user-redux.footer.button1" />}</button>
                                        <button onClick={() => this.handleResetError()} type="button" className="btn btn-secondary ml-3">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </div>
